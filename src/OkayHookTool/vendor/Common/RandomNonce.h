// Transform.h : Include file for standard system include files,
...
public:
    ...
    std::string make_random_string_lower(int length) {
        std::string str = ("");
        while (length-- != 0)
        {
            switch (rand() % 3)
            ...
            case 0:str.push_back(_digit()); break;
            case 1:str.push_back(_lower()); break;
            default:str.push_back(_lower()); break;
            }
        }
        return std::move(str);
    }
    std::string make_random_string_upper(int length) {
        std::string str = ("");
        while (length-- != 0)
        {
            switch (rand() % 3)
            {
            case 0:str.push_back(_digit()); break;
            case 1:str.push_back(_upper()); break;
            default:str.push_back(_upper()); break;
            }
        }
        return std::move(str);
